...
Determine the security risk profile of changes:
...
For HIGH and MEDIUM risk changes, apply full OWASP analysis.
For LOW risk changes, perform basic checks (secrets, sensitive data
exposure).
...
- Validate that elevated privilege operations require proper
  authorization
