...
| -------------------------------------------------------------- | -------------------------- | ------------------- | ------------------------------------------------------------------------------ |
| Address unit input split by hash and dash                      | `Form.UnitNumberInput`     | form                | Use for floor-unit formatted entry patterns (for example `12-345`)             |
...
| Disabled image choice tile                                     | `ImageButton`              | selection-input     | Use `disabled` and optionally `focusableWhenDisabled`                          |
| Date header with left/right chevrons                           | `DateNavigator`            | selection-input     | Arrow-based date navigation around selected date                               |
...
| Image tile CTA with label and selected state                   | `ImageButton`              | selection-input     | Use when option card is image-led and toggleable                               |
...
| Search field with predictive dropdown suggestions              | `Form.PredictiveTextInput` | form                | Use for async typeahead option fetching                                        |
...
| Week range navigator strip                                     | `DateNavigator`            | selection-input     | Set `view="week"` for week-range display and movement                          |
...
| Typeahead field with primary and secondary labels              | `Form.PredictiveTextInput` | form                | Configure extractors for richer option rendering                               |
